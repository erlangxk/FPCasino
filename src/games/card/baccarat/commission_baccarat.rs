...
mod tests {
    ...
    fn test_result_payout_map_banker() {
        ...
        assert_eq!(result_payout_map(Result::Banker(8)),hashmap!{Bets::Banker => 1.95, Bets::BankerN8 => 9.0});
        assert_eq!(result_payout_map(Result::Banker(9)),hashmap!{Bets::Banker => 1.95, Bets::BankerN9 => 9.0});
    }
